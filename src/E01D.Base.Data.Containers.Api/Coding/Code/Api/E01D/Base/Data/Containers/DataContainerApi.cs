using Root.Coding.Code.Api.E01D.Base.Data.Containers;
using Root.Coding.Code.Models.E01D.Base.Pocos;
using Root.Coding.Code.Models.E01D.Base.Results;

namespace Root.Coding.Code.Api.E01D.Core.Data
{
    public abstract class DataContainerApi<T> : DataContainerApi_I<T>
         where T : Poco_I
    {
