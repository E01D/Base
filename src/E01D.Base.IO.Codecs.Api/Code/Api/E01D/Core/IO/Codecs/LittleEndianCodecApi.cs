using System;
using Root.Code.Api.E01D.Core.IO.Codecs.LittleEndian;
using Root.Code.Domains.E01D;
using Root.Code.Models.E01D.Core.IO;

namespace Root.Code.Api.E01D.Core.IO.Codecs
{
    public class LittleEndianCodecApi:EndianCodec_I
    {
        #region Properties
        ...
        public char ReadChar(BlockStream_I stream)
        {
            return Char.Read(stream);
        }
        ...
        public char[] ReadAsciiChars(Block_I block, int length)
        {
            return Char.ReadAscii(block, length);
        }

        public char ReadAsciiChar(Block_I block)
        {
            return Char.ReadAscii(block);
        }
        ...
        {
            return UInt32.Read(blockStream);
        }

        public ulong ReadUInt64(BlockStream_I blockStream)
        {
            return UInt64.Read(blockStream);
        }

        public void WriteAsciiChar(Block_I block, char value)
        {
            Char.WriteAscii(block, value);
        }
    }
}
