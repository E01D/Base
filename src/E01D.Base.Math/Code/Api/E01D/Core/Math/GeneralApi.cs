...
namespace Root.Code.Api.E01D.Core.Math
{
    public class GeneralApi
    {
        ...
        public int? Min(int? val1, int? val2)
        {
            ...
            return System.Math.Min(val1.GetValueOrDefault(), val2.GetValueOrDefault());
        }
        ...
        public int? Max(int? val1, int? val2)
        {
            ...
            return System.Math.Max(val1.GetValueOrDefault(), val2.GetValueOrDefault());
        }
