...
namespace Root.Code.Api.E01D.Core.Collections.Dictionaries
{
    public class HashingApi
    {
        ...
        private ConditionalWeakTable<object, SerializationInfo> s_serializationInfoTable;

        internal ConditionalWeakTable<object, SerializationInfo> SerializationInfoTable => LazyInitializer.EnsureInitialized(ref s_serializationInfoTable);

        internal object GetEqualityComparerForSerialization(object comparer) => comparer;
